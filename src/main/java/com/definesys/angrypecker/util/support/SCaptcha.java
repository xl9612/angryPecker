package com.definesys.angrypecker.util.support;
...
public class SCaptcha {
    ...
    public ByteArrayOutputStream write(OutputStream sos) throws IOException {
        ImageIO.write(buffImg, "jpg", sos);
        return (ByteArrayOutputStream)sos;
    }
